...
CREATE TABLE conjugation (
    ...
    first_person_singular VARCHAR(255) COLLATE "hy_AM.UTF-8" NOT NULL,
    second_person_singular VARCHAR(255) COLLATE "hy_AM.UTF-8" NOT NULL,
    third_person_singular VARCHAR(255) COLLATE "hy_AM.UTF-8" NOT NULL,
    first_person_plural VARCHAR(255) COLLATE "hy_AM.UTF-8" NOT NULL,
    second_person_plural VARCHAR(255) COLLATE "hy_AM.UTF-8" NOT NULL,
    third_person_plural VARCHAR(255) COLLATE "hy_AM.UTF-8" NOT NULL,

...
CREATE TABLE conjugation (
    ...
    first_person_singular VARCHAR(255) NOT NULL,
    second_person_singular VARCHAR(255) NOT NULL,
    third_person_singular VARCHAR(255) NOT NULL,
    first_person_plural VARCHAR(255) NOT NULL,
    second_person_plural VARCHAR(255) NOT NULL,
    third_person_plural VARCHAR(255) NOT NULL,

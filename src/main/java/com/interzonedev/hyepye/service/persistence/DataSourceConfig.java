package com.interzonedev.hyepye.service.persistence;
 ...
 */
@Configuration("hyepye.service.dataSource.config")
public class DataSourceConfig {
	 ...
	 * @throws ClassNotFoundException Thrown if the connection pool class could not be found on the classpath.
	 */
	@ConfigurationProperties(prefix = "hyepye.persistence.datasource")
	@Bean(name = "hyepye.service.dataSource")
	public DataSource getDataSource() throws URISyntaxException, ClassNotFoundException {
		...
		String connectionPoolClassName = environment.getProperty("hyepye.persistence.datasource.connection-pool-class-name");
		String dbScheme = environment.getProperty("hyepye.persistence.datasource.scheme");
		String dbDriverClassName = environment.getProperty("hyepye.persistence.datasource.driver-class-name");

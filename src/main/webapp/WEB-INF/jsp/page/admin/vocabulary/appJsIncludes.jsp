...
<script src="<c:url value="/assets/js/app/admin/services/AdminService.js" />"></script>
<script src="<c:url value="/assets/js/app/admin/vocabulary/vocabularyAdminApp.js" />"></script>
...
<script src="<c:url value="/assets/js/app/common/controllers/AlertCtrl.js" />"></script>
